  ...
  if (!order) {
    return (
      <div className='max-w-[1920px] w-auto mx-auto py-12'>
        <h1 className='text-3xl font-bold text-center text-red-600'>Order Not Found</h1>
        <p className='text-center text-gray-600 mt-4'>We couldn't find the order details. Please try again.</p>
      </div>
    );
  }
