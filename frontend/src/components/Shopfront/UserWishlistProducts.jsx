     ...
     return (  
      <Link to={`/product/${item.id}`}  >  
       <motion.div 
                ...
                whileTap={{ scale: 0.95 }} class="w-full max-w-sm bg-white border border-gray-200 rounded-lg shadow-sm dark:bg-gray-800 dark:border-gray-700 hover:shadow-lg">
              <a href="#">
                <img
