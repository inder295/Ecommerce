    ...
    <>
      {!authUser ? (
        <Link to="/signin" className="">
          <button
            type="button"
            className="text-white bg-blue-600 hover:bg-blue-400 focus:outline-none focus:ring-4 focus:ring-gray-300 font-medium rounded-lg text-sm px-5 py-2 dark:bg-gray-800 dark:hover:bg-gray-700 dark:focus:ring-gray-700 dark:border-gray-700"
          >
            Sign In
          </button>
        </Link>
