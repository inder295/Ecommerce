...
const Faq = () => {
    ...
    const faqs = [
        ...
        },
        {
            ...
            answer: "No — opening a shop is completely free!You can start selling instantly without any hidden costs.We only charge a small commission on each sale to keep the marketplace running smoothly.",
        },
        {
            question: "How do customers make purchases safely?",
            answer: "Customers can browse shops, add products to their cart, and pay securely through our integrated payment gateway.All transactions are encrypted, ensuring your payment and personal details stay protected.",
        },
        {
            question: "How do I track my orders and sales?",
            answer: "Both sellers and customers get real-time dashboards to track every order.Sellers can see sales reports and inventory updates, while customers can check order status and delivery progress anytime.",
        },
    ];
    return (
        <>
