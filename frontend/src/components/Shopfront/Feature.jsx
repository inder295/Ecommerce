      ...
      <div className="flex flex-wrap items-center justify-center gap-10 mt-16">
        <div className="max-w-80 hover:-translate-y-0.5 transition duration-300">
          ...
          <p className="text-sm text-slate-600 mt-1">
            Track your sales, revenue, and customer trends in real time with
            powerful analytics.
          </p>
        </div>
        <div className="max-w-80 hover:-translate-y-0.5 transition duration-300">
          ...
          <p className="text-sm text-slate-600 mt-1">
            Create beautiful, responsive storefronts that attract customers and
            boost conversions.
          </p>
        </div>
        <div className="max-w-80 hover:-translate-y-0.5 transition duration-300">
          ...
          <p className="text-sm text-slate-600 mt-1">
            Connect with buyers worldwide and manage your products seamlessly
            from one place.
          </p>
        </div>
      </div>
