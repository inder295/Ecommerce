...
const Testimonial = () => {
    ...
    const CreateCard = ({ card }) => (
        ...
        <div className="p-4 rounded-lg mx-4 shadow hover:shadow-lg transition-all duration-200 w-72 shrink-0">
            ...
            <p className="text-sm py-4 text-gray-800">Thanks to this platform, my small shop turned into a growing online brand.</p>
    ...
    return (
        ...
        viewport={{ once: true, amount: 0.3 }}
            className="marquee-row w-full mx-auto max-w-5xl overflow-hidden relative">
                ...
                <h1 className="text-3xl font-semibold text-center mx-auto">Our Stories </h1>
